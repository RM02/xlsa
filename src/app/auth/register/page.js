...
export default function Register () {
    ...
    return(
        <div className="flex min-h-full flex-col justify-center px-4 py-12 lg:px-4">
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-lg">
                ...
                <form>
                    <div className="space-y-12">
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div className="mt-2">
                                ...
                                <input type="text" name="username" id="username" autocomplete="username" className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"></input>
                                </div>
                            </div>
                            </div>
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                        <button type="button" className="text-sm font-semibold leading-6 text-gray-900" onClick={() => router.push("/")}>Cancel</button>
