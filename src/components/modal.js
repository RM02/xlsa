export default function Modal ({ config, ok, cancel }) {
            ...
            <div className="fixed inset-0 z-10 overflow-y-auto">
                ...
                <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                    ...
                    <div className="sm:flex sm:items-start">
                        ...
                        <h3 className="text-base font-semibold leading-6 text-gray-900" id="modal-title">{config.title}</h3>
                        <div className="mt-2">
                    ...
                    <button onClick={() => ok()} type="button" className={config.className}>{config.okText}</button>
                    <button onClick={() => cancel()} type="button" className="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto">{config.cancelText}</button>
                    </div>
                </div>
                </div>
            </div>
